...
# ----- Mesh from gmsh ----- #
name, comm = "undrained", MPI.COMM_WORLD
...
dict_ = {'Axial_stress':σa,'Radial_stress':σr,'Axial_strain':εa,'Volumetric_strain':εv,'Pore_pressure':pp,'time':t}
